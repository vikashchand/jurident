...
const AboutusBox = () => {
  return (
    <>
<<<<<<< HEAD
      <div className="bg-[#D9D9D9] w-[300px] h-[400px] md:w-[700px] md:h-[500px] rounded-xl">
=======
      <div className="bg-[#D9D9D9] w-[300px] h-[625px] md:w-[700px] md:h-[575px] rounded-xl">
...
=======
        <button className="ml-[15%] mt-[5%] md:mt-[35%] md:ml-[35%] border-2 rounded-xl border-solid border-black bg-white p-4 md:hover:bg-red-200 transition duration-200">
          GO TO PROFILE PAGE 
        </button>
>>>>>>> e2d7ba34e92704af3e995648f87cee53bac263d6
      </div>
